...
function ContactUs() {
  ...
  // biome-ignore lint/correctness/useExhaustiveDependencies: animateIn is stable; adding it would re-run on every render
  useEffect(() => {
    if (currentIndex >= 0) {
      animateIn();
    }
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div className="text-label text-xs sm:text-sm">
                    <label htmlFor="terms" className="cursor-pointer">
                      I accept the{" "}
                      <a href="/about" className="text-primary hover:text-primary/80 underline">
                        Terms
                      </a>
                    </label>
